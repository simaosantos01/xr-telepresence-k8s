...
import (
	...
	"mr.telepresence/gc/internal/controller"
...
func init() {
	...
	utilruntime.Must(telepresencev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1da58e50.mr.telepresence",
	...
	if err = (&controller.GCReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Garbage Collector")
		os.Exit(1)
	}
