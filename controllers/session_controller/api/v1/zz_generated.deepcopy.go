...
func (in *BackgroundPod) DeepCopyInto(out *BackgroundPod) {
	*out = *in
	in.PodSpec.DeepCopyInto(&out.PodSpec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackgroundPod.
func (in *BackgroundPod) DeepCopy() *BackgroundPod {
	if in == nil {
		return nil
	}
	out := new(BackgroundPod)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClientBackgroundPodsStatus) DeepCopyInto(out *ClientBackgroundPodsStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClientBackgroundPodsStatus.
func (in *ClientBackgroundPodsStatus) DeepCopy() *ClientBackgroundPodsStatus {
	if in == nil {
		return nil
	}
	out := new(ClientBackgroundPodsStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SessionSpec) DeepCopyInto(out *SessionSpec) {
	*out = *in
	if in.BackgroundPods != nil {
		in, out := &in.BackgroundPods, &out.BackgroundPods
		*out = make([]BackgroundPod, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SessionStatus) DeepCopyInto(out *SessionStatus) {
	*out = *in
	...
	if in.Clients != nil {
		in, out := &in.Clients, &out.Clients
		*out = make([]ClientBackgroundPodsStatus, len(*in))
		copy(*out, *in)
	}
}
